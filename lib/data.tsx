import {
    ...
    rag_chatbot,
    ssh_chatbot,
} from '../app/assets/projects_images';
...
export const projectsData = [
    {
        ...
        description:
            'Developed a Retrieval-Augmented Generation AI System on a RESTful API that allows you to easily populate the system with your own documents and effortlessly retrieve any specific information by simply asking a question.',
    ...
    },
    {
        ...
        description:
            'A command-line SSH chat application that enables users to create and join chat rooms for secure, real-time communication using the SSH protocol.',
    ...
    },
    {
        title: 'Martial Gear',
        description:
            'Developed a martial arts e-commerce shop featuring an AI-powered chatbot integrated with OpenAI to assist customers. The site includes a shopping cart, advanced product filtering and sorting, and is powered by a CMS (Sanity.io).',
    ...
    },
    {
        title: 'CaliBrunch',
        description:
            'Designed and implemented a brunch restaurant website. The project was developed entirely using JavaScript and CSS without any libraries or frameworks, with the goal of showcasing my understanding of core web development fundamentals.',
    ...
    },
    {
        title: 'DiveRight',
        description:
            'Designed and implemented a front page for a diving center website. The webpage was built using React.js and Tailwind CSS. The inspiration for this project came from my passion for scuba diving.',
