...
export default function Home() {
    ...
    const hueHero = useTransform(
        scrollYProgress,
        [0, 0.25, 0.6, 0.7, 0.9, 1],
        [0, 0, 40, 65, 100, 100]
    );
    ...
    const hueHeroSmallScreens = useTransform(
        scrollYProgress,
        [0, 0.2, 0.3, 0.6, 1],
        [0, 0, 50, 100, 100]
    );
    const opacityAboutSectionSmallScreens = useTransform(
        scrollYProgress,
        [0, 0.45, 0.6],
        [0, 0.7, 1]
    );
    ...
    const opacityProject = useTransform(
        scrollYProgressEndSection,
        [0, 0.7, 0.8, 0.9, 1],
        [1, 1, 1, 0, 0]
    );
    ...
    const backgroundColorProject = useTransform(hueProject, [0, 100], ['#f5f5f7', '#0a192f']);

    const backgroundColorHero = useTransform(hueHero, [0, 100], ['#0a192f', '#f5f5f7']);
                ...
                <motion.div
                    ...
                    style={{
                        backgroundColor: isSmallScreen
                            ? backgroundColorProjectSmallScreens
                            : backgroundColorHero,
                    }}
                >
                    <motion.div
                    ...
                    <motion.div
                        ...
                        style={{
                            opacity: isSmallScreen
                                ? opacityAboutSectionSmallScreens
                                : opacityAboutSection,
                        }}
                    >
                        <motion.div
                            style={{
                                scale: isSmallScreen ? scaleHamburgerSmallScreens : scaleHamburger,
                            }}
